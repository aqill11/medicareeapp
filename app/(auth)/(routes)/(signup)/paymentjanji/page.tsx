    ...
    return (
        <div className="relative flex flex-col min-h-screen py-2 bg-white">
            ...
            <div className="flex justify-between -mt-40 ml-4 py-8 relative">
                <p className="font text-xl text-gray-500">Biaya Layanan</p>
                <p className="text-xl mr-9 text-gray-500">Rp. 2.000</p>
            </div>
            ...
            <div className="flex justify-between -mt-60 ml-12 py-12 relative">
                <p className="-ml-8 text-xl mt-2 text-gray-500">Biaya Konsultasi</p>
                <p className="text-xl mt-2 mr-9 text-gray-500">Rp. 180.000</p> 
            </div>
            ...
            <div className="flex justify-between -mt-2 ml-4 py-8 relative">
                ...
                <p className="text-black font-semibold text-2xl -mt-6 mr-9">Rp. 180.000</p> 
            </div>
