...
import polm from '../public/polm.png';
import kh from '../public/kh.jpg';
    ...
    return (
        <div className="relative flex flex-col min-h-screen py-2 bg-white">
            ...
            <div className="relative flex flex-col items-center mt-14">
                ...
                <div className="absolute mt-64 py-80 -top-5 -mr-48 font-sans text-center">
                    <p className="font-bold text-xl -mr-60 text-white">Konfirmasi </p>
                </div>
            </div>
