...
export default function Home() {
    return (
        <div className="relative flex flex-col min-h-screen py-2 bg-white">
            ...
            <div className="flex flex-col items-center">
               ...
               <div className="fixed top-48 left-0 right-6 mt-40 ml-40">
    <a href="#" className="text-gray-800 hover:text-green-500 font-extrabold">Konsultasi</a>
</div>
    ...
    <a href="#" className="text-gray-800 hover:text-green-500 font-bold">Buat Janji RS</a>
</div>
