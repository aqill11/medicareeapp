...
export default function Home() {
    return (
        <div className="relative flex flex-col min-h-screen py-2 bg-white">
            ...
            <div className="mr-auto -mt-40 mb-4 ml-6 py-3 relative flex items-center">
                <Image 
                    src={cw} 
                    alt="cw.png" 
                    layout="fixed" 
            ...
            <div className="mr-auto -mt-36 ml-36 py-2 mb-3 relative flex items-center">
            <span className=" ml-1 text-gray-500 text-lg">Dokter Umum</span>
            </div>

            <div className="mr-auto -mt-6 ml-44 py-2 relative flex items-center">
            <a href="#" className=" hover:text-green-500 -ml-7 font-bold text-xs text-gray-500">Rumah Sakit. RS Bhakti Medicare</a>
            </div>

            <div className="mr-auto ml-36 mb-4 relative flex items-center">
            <span className=" ml-1 text-black text-lg">Rp. 180.000</span>
            </div>
            
            
            <div className="max-w-32xl mt-5 mb-5 mx-auto relative">
            ...
            <div className="mr-auto -mt-40 mb-8 ml-6  relative flex items-center">
                <Image 
                    src={cw} 
                    alt="cw.png" 
                    layout="fixed" 
                    ...
                    placeholder='blur'
                />
                <a href="#" className="ml-4 -mt-24 mb-1 hover:text-green-500 text-black text-lg">Dr Nabila Davega</a>
            </div>

            <div className="mr-auto -mt-36 ml-36 py-2 mb-5 relative flex items-center">
            <span className=" ml-1 text-gray-500 text-lg">Dokter Umum</span>
            </div>
            ...
            <div className="mr-auto ml-36 py-2 -mt-2 relative flex items-center">
            <span className=" ml-1 text-black text-lg">Rp. 130.000</span>
            </div>

           

            
            <div className="max-w-32xl mt-6 mx-auto relative">
            ...
            <div className="mr-auto -mt-36 ml-6 py-2 relative flex items-center">
                <Image 
                    ...
                    placeholder='blur'
                />
                <a href="#" className="ml-4 -mt-24 mb-5 hover:text-green-500 text-black text-lg"> Dr Rama Dani Putra</a>
            </div>

            <div className="mr-auto -mt-32 ml-36 py-2 mb-5 relative flex items-center">
            <span className=" ml-1 text-gray-500 text-lg">Dokter Umum</span>
            </div>
            ...
            <div className="mr-auto ml-36 py-2 -mt-2 mb-1 relative flex items-center">
            <span className=" ml-1 text-black text-lg">Rp. 150.000</span>
            </div>

           

            
            <div className="max-w-32xl mt-8 mx-auto relative">
            ...
            <div className="mr-auto -mt-36 ml-6 py-2 relative flex items-center">
                <Image 
                    ...
                    placeholder='blur'
                />
                <a href="#" className="ml-4 -mt-24 mb-5 hover:text-green-500 text-black text-lg">Dr Ulyandini</a>
            </div>
            ...
            <span className=" ml-1 text-black text-lg">Rp. 140.000</span>
            </div>
